...
var _chunkCLAOIJUNjs = require('./chunk-CLAOIJUN.js');
...
function resolveOptions(options = {}, root = process.cwd()) {
  ...
  const resolved = _chunkCLAOIJUNjs.__spreadProps.call(void 0, _chunkCLAOIJUNjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkCLAOIJUNjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkCLAOIJUNjs.presets[definition];
